...
//Interactions
    ...
    Interaction strain
    {
        type = strain;
        group1 = e1;
        E = "2.154e-04 2.154e-04 2.154e-04";
        D = "13.3 21.5 20";
    ...
    Interaction strain_modulated
    {
        type = strain;
        group1 = e1;
        E = "1.077e-04 1.077e-04 1.077e-04";
        D = "13.3 21.5 20";
        prefactor = 0.035682426404996;
...
Run
{
    Task TE
    {
        ...
        logfile    = "NV_Centre_N14_results/NV_centre_N14_GS-T-4.log";
        datafile   = "NV_Centre_N14_results/NV_centre_N14_GS-T-4.dat";
