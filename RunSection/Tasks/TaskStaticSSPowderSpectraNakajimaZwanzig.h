...
namespace RunSection
{
	...
	private:
		...
		// NZ relaxation helper methods. These operate in the orientation-specific
		// H0 eigenbasis and then return to the task propagation basis.
		...
		bool BuildNakajimaZwanzigLiouvillian(std::vector<SpinAPI::system_ptr>::const_iterator &_i, SpinAPI::SpinSpace &_space, const arma::cx_mat &_H, const arma::cx_mat &_relaxationBasisHamiltonian, const arma::mat &_rotationmatrix, arma::cx_mat &_A, arma::cx_mat &_eigenvec, bool _logdiagnostics);
